...
export default function Landing() {
  ...
  const handleCount = (type) => {
    if (currentRoundCount >= 1 && currentRoundCount <= 7) {
      if (currentRoundCount === 1 && type === "sub") {
        setRoundCount(currentRoundCount + 0);
      } else if (currentRoundCount === 7 && type === "add") {
        setRoundCount(currentRoundCount + 0);
      } else {
        if (type === "sub") {
  ...
  return (
    <>
      <div className=" ">
        <video
          className=" fixed object-cover  top-0 -z-50 min-h-screen min-w-full"
          ref={vidRef}
          src="background.mp4"
          loop
          autoPlay
      ...
      <div className="h-screen w-screen  bg-transparent flex flex-col  justify-evenly items-center overflow-hidden relative">
        ...
        <div className="flex justify-evenly w-full md:w-2/6">
          <div className="cursor-pointer bg-gray-700 p-1 rounded-xl transition-all duration-300 hover:-translate-y-1">
            <div
              onClick={() => {
                handlePopup();
              }}
        ...
        {/**-----------------------Create Game UI----------------------- */}
        <div
          className={`${popup} w-screen h-screen bg-fainted absolute top-0 flex justify-center items-center transition-all duration-300`}
        >
          <div
            ...
            <div className="w-full h-full flex flex-col justify-evenly items-center">
              ...
              <div className="flex flex-col text-center">
                ...
                <input
                  ...
                  className={`${
                    emptyUser === true ? " border-4 border-red-500" : ""
                  } p-2  rounded-full text-center focus:border-purple-500 focus:border-2 focus:shadow-md focus:shadow-purple-400 focus:outline-none transition-all duration-300`}
                  type="text"
              ...
              <div className="w-1/2 flex flex-col  items-center ">
                ...
                <div className="flex justify-evenly items-center  text-xl w-full">
                  <span
                    ...
                    className="bg-purple-500 w-10 h-10 flex justify-center items-center rounded-full hover:cursor-pointer active:translate-y-1 transition-all duration-100"
                  >
                    <FontAwesomeIcon
          ...
          <div className="relative md:w-2/6 h-4/6 w-5/6 bg-gray-300 rounded-md flex justify-evenly items-center flex-col">
            <div className="flex flex-col text-center">
              ...
              <input
                ...
                className={`${
                  emptyUser === true ? " border-4 border-red-500" : ""
                } p-2  rounded-full mb-10 text-center focus:border-purple-500 focus:border-2 focus:shadow-md focus:shadow-purple-400 focus:outline-none transition-all duration-300`}
                type="text"
                placeholder="Enter Username"
              />
              Room ID
              <input
                ...
                className="p-2  rounded-full text-center focus:border-purple-500 focus:border-2 focus:shadow-md focus:shadow-purple-400 focus:outline-none transition-all duration-300 "
                type="text"
        ...
        <div
          ...
          className="absolute bottom-24 md:bottom-10 hover:cursor-pointer right-10 text-4xl text-white"
        >
        ...
        <div
          className={`${
            aboutIsOpen ? "" : "translate-x-full"
          } h-screen w-screen md:w-1/4 md:right-0 bg-white absolute top-0 flex flex-col justify-evenly items-center transition-all duration-300`}
        >
          <span className="text-xl text-gray-500">
            Made by{" "}
            <span className="font-bold text-green-600">Mathew Salazar</span>
          </span>
          <div className="flex text-5xl w-full justify-evenly ">
            <div
              onClick={() => {
                openUrl("https://twitter.com/SnrMattSalazar");
              }}
            ...
            <div
              onClick={() => {
                openUrl("https://github.com/SnrMatt");
              }}
              className="hover:text-green-500  rounded-full hover:cursor-pointer"
            >
              <FontAwesomeIcon icon={faGithub} />
            </div>
            <div
              onClick={() => {
                openUrl("https://msalazar.org");
              }}
          ...
          <div
            ...
            className="hover:cursor-pointer w-14 h-14 rounded-full bg-red-500 flex justify-center items-center text-white text-3xl"
          >
            <FontAwesomeIcon icon={faXmark} />
          </div>
          <div className="absolute bottom-24 text-gray-400">
            Tip: The faster you draw the more ink you get ;P
          </div>
        </div>
      </div>
    </>
